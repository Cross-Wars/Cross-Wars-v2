  ...
  return (
    <footer className="footer-container">
      <div className="footer-left">
        <a className="author" href="https://www.linkedin.com/in/lucas-mcgill/">
          <img
        ...
        <a className="author" href="https://www.linkedin.com/in/sam-dokus/">
          <img
            src="https://theindianharvest.com/images/girl.png"
            width="90px"
          />
          <p>Sam Dokus</p>
        </a>
        <a className="author" href="https://www.linkedin.com/in/dipti-yadav/">
          <img
            src="https://orlan.org/wp-content/uploads/2018/07/girl-1-1.png"
            width="90px"
          />
          <p>Dipti Yadav</p>
        </a>
